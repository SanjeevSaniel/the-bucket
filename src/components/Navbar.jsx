...
const Navbar = () => {
  ...
  return (
    <div className="flex flex-row justify-between items-center px-6 lg:px-14 py-3 sticky top-0 z-20 bg-opacity-20 bg-gradient-to-r from-gray-900 to-slate-400 shadow-xl">
